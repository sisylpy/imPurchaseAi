...
toJrdh() {
  ...
  toLaodu(){
    ...
    wx.navigateTo({
      url: '../../subPackage/pages/yishang/nxDistributerGoods/nxDistributerGoods?nxDisId=' + this.data.disInfo.nxDistributerEntity.nxDistributerId + '&name=' + "ld" + '&toDepId=' + this.data.depId,
    })
  },
