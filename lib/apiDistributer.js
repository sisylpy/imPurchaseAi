...
export const cancleFinishPurGoodsGb = (data) => {
  return new Promise((resolve, reject) => {
    wx.request({
      url: apiUrl.apiUrl + 'gbdistributerpurchasegoods/cancleFinishPurGoodsGb' ,
      method: 'POST',
      data,
      success: (res) => {
        resolve({ result: res.data })
...
export const updateSelfPurGoodsOrdersCost = (data) => {
  return new Promise((resolve, reject) => {
    wx.request({
      url: apiUrl.apiUrl + 'gbdistributerpurchasegoods/updateSelfPurGoodsOrdersCost' ,
      method: 'POST',
      data,
      success: (res) => {
        resolve({ result: res.data })
...
export const getDepUsersByFatherIdGb = (data) => {
  return new Promise((resolve, reject) => {
    wx.request({
      url: apiUrl.apiUrl + 'gbdepartmentuser/getDepUsersByFatherIdGb/' + data ,
      method: 'GET',
      success: (res) => {
        resolve({ result: res.data })
      },
...
export const depGetSupplier = (data) => {
  return new Promise((resolve, reject) => {
    wx.request({
      url: apiUrl.apiUrl + 'nxjrdhsupplier/depGetSupplier/' +data,
      method: 'GET',
      success: (res) => {
        resolve({ result: res.data })
      },
...
export const getDepGoodsChartsProfit = (data) => {
  return new Promise((resolve, reject) => {
    wx.request({
      url: apiUrl.apiUrl + 'gbdepartmentgoodsdaily/getDepGoodsChartsProfit' ,
      method: 'POST',
      data: {
        depGoodsId: data.depGoodsId,
        startDate: data.startDate,
...
export const getDepGoodsCharts = (data) => {
  return new Promise((resolve, reject) => {
    wx.request({
      url: apiUrl.apiUrl + 'gbdepartmentgoodsdaily/getDepGoodsCharts' ,
      method: 'POST',
      data: {
        depId: data.depId,
        startDate: data.startDate,
...
export const getBillApplysGbDep = (data) => {
  return new Promise((resolve, reject) => {
    wx.request({
      url: apiUrl.apiUrl + 'gbdepartmentbill/getBillApplysGbDep' ,
      method: 'POST',
      data: {
        depFatherId: data.depFatherId,
        billId: data.billId
