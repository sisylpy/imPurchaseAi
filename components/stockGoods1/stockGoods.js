  ...
  methods: {
    ...
    radioChange(e) {
      ...
      if (type == 1) {
        ...
        console.log("typpeee======555", this.data.canSure)
        this.setData({
         canWaste: true,
          canChange: true,
        })
    ...
    getReturnReason(e) {
      ...
      this._checkReturnCanSure(e)
    },



    //选择图片
    choiceImgReturn: function (e) {
      var _this = this;
      wx.chooseImage({
    ...
    _checkReturnCanSure(){
      ...
      if ( this.data.srcReturn.length > 0 && this.data.reason.length > 0) {
        this.setData({
          canSure: true
        })
      } else {
    ...
    confirm(e) {
      if (this.data.canSure) {
        this.triggerEvent('confirm', {
          ...
          srcReturn: this.data.srcReturn,
          srcReturnLarge: this.data.srcReturnLarge,
