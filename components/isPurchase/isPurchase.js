Component({
  ...
  methods: {
    ...
    getPurchaseQuantity(e){
      ...
      var itemData = "item.nxDpgBuyQuantity";
      //输入非空 
    ...
    _countSubtotal(){
      ...
      var price = item.nxDpgBuyPrice;
      var quantity = item.nxDpgBuyQuantity;
      var subtotal = Number(price) * Number(quantity);
      var data = "item.nxDpgBuySubtotal";
      this.setData({
        [data]: subtotal.toFixed(1)
      })
      console.log("subtotott", this.data.item.nxDpgBuySubtotal);
    },
