...
Page({
  ...
  _initMendianArr(){
     ...
     if(mendianInfo){
       this.setData({
        depList: mendianInfo.gbDepartmentEntityList,
       })
     }
  },
  _initPurUser(){
 ...
 selectDep(e) {
  ...
  const dep = this.data.depList[index];
  
  console.log("选择部门:", dep);
  ...
  const selectedDepartment = {
    depId: dep.gbDepartmentId,
    depName: dep.gbDepartmentName
  };
  wx.setStorageSync('selectedDepartment', selectedDepartment);
  
  console.log("已设置部门缓存:", selectedDepartment);
